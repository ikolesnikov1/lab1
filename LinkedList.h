...
public:
    ...
    public:
        ...
        iterator & operator=(const iterator & extra);
        bool operator!=(const iterator & extra) const;
        bool operator==(const iterator & extra) const;
    ...
    public:
        ...
        const_iterator & operator=(const const_iterator & extra);
        bool operator!=(const const_iterator & extra) const;
        bool operator==(const const_iterator & extra) const;
        //Возвращает ссылку на текущий элемент коллекции.
    ...
    /* Конструкторы */
    LinkedList();
    LinkedList(const LinkedList & extra);
    LinkedList(LinkedList && extra) noexcept ;

    /* Деструктор */
    ~LinkedList();

    /* Оператор присваивания */
    LinkedList & operator=(const LinkedList & extra);
    LinkedList & operator=(LinkedList && extra);
